...
#
# Entry point for the bulk xQTL colocalization analysis with coloc.susie.
# Fill in the USER CONFIGURATION block below and run:
#
#   Rscript xqtl_coloc_susie.R
#
# The workflow is performed by bulk_colocalization_susie.R, which harmonises AD and QTL
# variants locus by locus and dispatches to the QTL-type specific implementations in
# functions/. SuSiE requires an LD reference panel in PLINK binary format.
...
# LD reference and temporary files for the SuSiE analyses
plink_bin <- "plink1.9"
ld_reference_prefix <- "path/to/LD_reference/TOPMed_chr"  # chromosome number is appended
...
source("bulk_colocalization_susie.R")
